...
void main() {
  group('RequestRange', () {
    runTest(String? value, RequestRange expected) {
  ...
  group('ResponseRange', () {
    runTest(String? value, ResponseRange expected) {
  ...
  group('appendQuery', () {
    runTest(String url, String queries, expected) {
      expect(appendQuery(url, queries), expected);
    }
    test('+anchor +queries', () {
      runTest('https://www.example.com?a=1#test', 'b=2&c=3', 'https://www.example.com?a=1&b=2&c=3#test');
    });
    test('+anchor -? -queries', () {
      runTest('https://www.example.com#test', 'b=2&c=3', 'https://www.example.com?b=2&c=3#test');
    });
    test('+anchor +? -queries', () {
      runTest('https://www.example.com?#test', 'b=2&c=3', 'https://www.example.com?b=2&c=3#test');
    });
    test('-anchor +queries', () {
      runTest('https://www.example.com?a=1', 'b=2&c=3', 'https://www.example.com?a=1&b=2&c=3');
    });
    test('-anchor endsWith & +queries', () {
      runTest('https://www.example.com?a=1&', 'b=2&c=3', 'https://www.example.com?a=1&b=2&c=3');
    });
    test('-anchor -? -queries', () {
      runTest('https://www.example.com', 'b=2&c=3', 'https://www.example.com?b=2&c=3');
    });
    test('-anchor +? -queries', () {
      runTest('https://www.example.com?', 'b=2&c=3', 'https://www.example.com?b=2&c=3');
    });
