...
void main() {
  ...
  test('local file multiple request', () async {
    ...
    try {
      ...
      var performRequest = (int begin, int end) async {
        http.Request request = http.Request('GET', Uri.parse(proxyUrl));
      ...
      await performRequest(501371111, 501375126);
    ...
    try {
      ...
      var performRequest = (int begin, int end) async {
        try {
          ...
          http.StreamedResponse response = await http.Client().send(request);
          return (await response.stream.toBytes()).length;
        } catch (e) {
      ...
      // Request after the file server closed, the cache will serve data
      print('Offline request...');
      expect(await performRequest(100, 1124), 1024, reason: 'A seeking request should return correct data after file server closed.');
      expect(await performRequest(0, 100), 100, reason: 'A seeking request should return correct data after file server closed.');
      expect(await performRequest(4096, null), expectedLength - 4096, reason: 'A seeking request should return correct data after file server closed.');
      http.Request request = http.Request('GET', Uri.parse(proxyUrl));
      http.StreamedResponse response = await http.Client().send(request);
      String checksum = await calcChecksum(response.stream.where((event) {
        received += event.length;
  ...
  test('local file restoring', () async {
    ...
    try {
      ...
      Map cacheData = jsonDecode(cacheDataStr);
      cacheData.forEach((key, value) => _server.caches[key] = CacheInfo.fromMap(value));
      await _server.start();
  ...
  test('test range contained in the cache in middle', () async {
    ...
    try {
      ...
      // prepare cached data
      await performRequest(0, 2097152);
      // perform the testing request
      List<int> actual = await performRequest(1048576, 1050624);
  ...
  test('test range contained in the cache to the end', () async {
    ...
    try {
      ...
      await performRequest(0, 2097152);
      // perform the testing request
      List<int> actual = await performRequest(1048576, 2097152);
  ...
  test('test range contained in the cache from the beginning', () async {
    ...
    try {
      ...
      // prepare cached data
      await performRequest(1048576, 3147776);
      // perform the testing request
      List<int> actual = await performRequest(1048576, 2097152);
      List<int> expected = await readFileInRange(testFilePath, 1048576, 2097152);
      expect(actual, expected);
  ...
  test('test range crosses the beginning of the cache', () async {
    ...
    try {
      ...
      // prepare cached data
      await performRequest(2097152, 3145728);
      // perform the testing request
      List<int> actual = await performRequest(1048576, 2099200);
  ...
  test('test range contains cache in middle', () async {
    ...
    try {
      ...
      // prepare cached data
      await performRequest(1050624, 2097152);
      // perform the testing request
      List<int> actual = await performRequest(1048576, 2099200);
      List<int> expected = await readFileInRange(testFilePath, 1048576, 2099200);
      expect(actual, expected);
  ...
  test('test range contains the cache from the beginning', () async {
    ...
    try {
      ...
      // prepare cached data
      await performRequest(1048576, 2097152);
      // perform the testing request
      List<int> actual = await performRequest(1048576, 2099200);
      List<int> expected = await readFileInRange(testFilePath, 1048576, 2099200);
      expect(actual, expected);
  ...
  test('test range contains the cache to the end', () async {
    ...
    try {
      ...
      // prepare cached data
      await performRequest(2097152, 2099200);
      // perform the testing request
      List<int> actual = await performRequest(1048576, 2099200);
      List<int> expected = await readFileInRange(testFilePath, 1048576, 2099200);
      expect(actual, expected);
  ...
  test('test range stays out of cache', () async {
    ...
    try {
      ...
      await performRequest(0, 2097152);
      // perform the testing request
      List<int> actual = await performRequest(2099200, 2101248);
  ...
  test('test range sticks discontinuously to the cache', () async {
    ...
    try {
      ...
      await performRequest(2099200, 3147776);
      // prepare cached data range 3
      await performRequest(3149824, null);
      // perform the testing request
      List<int> actual = await performRequest(2095104, 3151872);
